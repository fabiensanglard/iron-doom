...
pub const LOADNET: &str = concatcp!("you can't do load while in a net game!\n\n", PRESSKEY);
pub const QLOADNET: &str = concatcp!("you can't quickload during a netgame!\n\n", PRESSKEY);
pub const QSAVESPOT: &str = concatcp!("you haven't picked a quicksave slot yet!\n\n", PRESSKEY);
pub const SAVEDEAD: &str = concatcp!("you can't save if you aren't playing!\n\n", PRESSKEY);
pub const QSPROMPT: &str = concatcp!("quicksave over your game named\n\n'%s'?\n\n", PRESSYN);
pub const QLPROMPT: &str = concatcp!(
    "do you want to quickload the game named\n\n'%s'?\n\n",
    PRESSYN
);

pub const NEWGAME: &str = concatcp!(
    "you can't start a new game\nwhile in a network game.\n\n",
    PRESSKEY
);

pub const NIGHTMARE: &str = concatcp!(
    "are you sure? this skill level\nisn't even remotely fair.\n\n",
    PRESSYN
);

pub const SWSTRING: &str = concatcp!(
...
pub const NETEND: &str = concatcp!("you can't end a netgame!\n\n", PRESSKEY);
pub const ENDGAME: &str = concatcp!("are you sure you want to end the game?\n\n", PRESSYN);
...
pub const HUSTR_KEYGREEN: &str = "g";
pub const HUSTR_KEYINDIGO: &str = "i";
pub const HUSTR_KEYBROWN: &str = "b";
pub const HUSTR_KEYRED: &str = "r";
// ========================================================
